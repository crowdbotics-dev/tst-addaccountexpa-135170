"""
Django settings for tst_addaccountexpa_135170 project.
...
ROOT_URLCONF = 'tst_addaccountexpa_135170.urls'
...
WSGI_APPLICATION = 'tst_addaccountexpa_135170.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_addaccountexpa_135170 API",
    "DESCRIPTION": "API documentation for tst_addaccountexpa_135170 App",
    "VERSION": "v1",
}
